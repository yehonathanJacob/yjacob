...
_libs = ["/lib/python","/tools/nlp","/tools/image/food/FoodDB/lib"]
for l in _libs:
...
POSTGRES_HOST = os.environ.get('FOODDB_POSTGRES_HOST', 'foods.icx-il.com')
...
logging.info("Using settings_train.py")
