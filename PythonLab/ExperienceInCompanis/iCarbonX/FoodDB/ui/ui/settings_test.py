...
POSTGRES_HOST = os.environ.get('FOODDB_POSTGRES_HOST', 'foods-test.icx-il.com')
...
IMAGES_ROOT = '/data/data/IMAGE/CLASSIFICATION/'
...
# NLP
NLP_SERVER =  os.environ.get('NLP_HOST',  'nlp2-test.icx-il.com')
NLP_PORT = '5000'
